...
const iconMap = {
  ...
  "jadwal-edukator-admin": '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="5" width="18" height="16" rx="2" stroke-width="1.5"/><path d="M16 3v4M8 3v4M3 11h18" stroke-width="1.5" stroke-linecap="round"/><circle cx="12" cy="15" r="2" stroke-width="1.5"/><path d="M8 20a4 4 0 0 1 8 0" stroke-width="1.5" stroke-linecap="round"/></svg>',
...
const labelMap = {
  ...
  "jadwal-edukator-admin": "Jadwal Edukator",
...
const groupMap = {
  ...
  "jadwal-edukator-admin": "akademik",
